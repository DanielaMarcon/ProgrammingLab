  ...
  def get_data(self):
    ...
    if not self.can_read:
      ...
      for line in my_file:
        ...
        # p.s. in realtà strip() toglie anche gli spazi
...
class NumericalCSVFile(CSVFile):
  ...
  def get_data(self):
    ...
    for string_row in string_data:
      ...
      # enumeratore: così ho gratis l'indice "i" della
      ...
      for i, element in enumerate(string_row):
        ...
        if i == 0:
          ...
          # Converto a float tutti gli altri. Ma se fallisco, stampo
          # l'errore e rompo il ciclo (e poi salterò la riga)
          try:
...
mio_file_numerico = NumericalCSVFile(name = 'sales.csv')
